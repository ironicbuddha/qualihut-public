...
var config = {
  configuration: {
    ...
    analytics: null,
    locale: "en-US",
    baseUrl: "carlo.github.io/qualihut-public",
  ...
  plugins: {
    ...
    emitters: [
      ...
      Favicon(),
      NotFoundPage()
      // Custom OG image generation is expensive during local iteration.
      // Re-enable this when you need social preview images for deploys.
